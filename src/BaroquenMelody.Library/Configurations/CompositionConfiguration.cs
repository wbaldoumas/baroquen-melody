...
/// <param name="VoiceRhythmConfiguration"> The configuration of per-voice rhythm roles (a held voice and a florid voice rotating over phrase blocks of the fugal body). When <see langword="null"/> (including configurations saved before voice rhythm existed), <see cref="Configurations.VoiceRhythmConfiguration.Default"/> is used. </param>
