...
internal sealed class AvoidParallelOctaves(CompositionConfiguration compositionConfiguration) : ICompositionRule
{
    public bool Evaluate(IReadOnlyList<BaroquenChord> precedingChords, BaroquenChord nextChord)
    {
        ...
        for (var i = 0; i < voiceCombinations.Size; ++i)
        {
            ...
            if (precedingNote1.IsPerfectOctaveWith(precedingNote2) && currentNote1.IsPerfectOctaveWith(currentNote2))
            {
                return false;
            }
        }
