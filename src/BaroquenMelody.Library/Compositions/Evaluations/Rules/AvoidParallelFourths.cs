...
internal sealed class AvoidParallelFourths(CompositionConfiguration compositionConfiguration) : ICompositionRule
{
    public bool Evaluate(IReadOnlyList<BaroquenChord> precedingChords, BaroquenChord nextChord)
    {
        ...
        for (var i = 0; i < voiceCombinations.Size; ++i)
        {
            ...
            if (precedingNote1.IsPerfectFourthWith(precedingNote2) && currentNote1.IsPerfectFourthWith(currentNote2))
            {
                return false;
            }
        }
