    ...
    private IPolicyEngine<OrnamentationCleaningItem> BuildPassingToneOrnamentationCleanerEngine() => PolicyEngineBuilder<OrnamentationCleaningItem>.Configure()
        .WithInputPolicies(
            new NotesContainTargetOrnamentations(OrnamentationType.PassingTone, OrnamentationType.PassingTone)
                ...
                .Or(new NotesContainTargetOrnamentations(OrnamentationType.NeighborTone, OrnamentationType.PassingTone))
                .Or(new NotesContainTargetOrnamentations(OrnamentationType.NeighborTone, OrnamentationType.DoublePassingTone))
                .Or(new NotesContainTargetOrnamentations(OrnamentationType.NeighborTone, OrnamentationType.RepeatedEighthNote))
                ...
                .Or(new NotesContainTargetOrnamentations(OrnamentationType.DelayedNeighborTone, OrnamentationType.DelayedNeighborTone))
                .Or(new NotesContainTargetOrnamentations(OrnamentationType.DelayedNeighborTone, OrnamentationType.DelayedPassingTone))
                .Or(new NotesContainTargetOrnamentations(OrnamentationType.DelayedNeighborTone, OrnamentationType.DelayedDoublePassingTone))
                .Or(new NotesContainTargetOrnamentations(OrnamentationType.DelayedNeighborTone, OrnamentationType.RepeatedDottedEighthSixteenth))
        )
