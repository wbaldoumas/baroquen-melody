...
/// </summary>
/// <param name="ContextualizedNotes"> The notes which make up the chord. </param>
...
internal sealed record ContextualizedChord(ISet<ContextualizedNote> ContextualizedNotes, ChordContext ArrivedFromChordContext, ChordChoice ArrivedFromChordChoice);
