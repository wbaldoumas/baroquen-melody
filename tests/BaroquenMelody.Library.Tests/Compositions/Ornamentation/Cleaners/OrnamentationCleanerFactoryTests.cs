...
internal sealed class OrnamentationCleanerFactoryTests
{
    ...
    [TestCase(OrnamentationType.NeighborTone, OrnamentationType.NeighborTone, typeof(PassingToneOrnamentationCleaner))]
    [TestCase(OrnamentationType.NeighborTone, OrnamentationType.DelayedPassingTone, typeof(PassingToneOrnamentationCleaner))]
    [TestCase(OrnamentationType.NeighborTone, OrnamentationType.DelayedDoublePassingTone, typeof(PassingToneOrnamentationCleaner))]
    [TestCase(OrnamentationType.NeighborTone, OrnamentationType.RepeatedDottedEighthSixteenth, typeof(PassingToneOrnamentationCleaner))]
    [TestCase(OrnamentationType.DelayedPassingTone, OrnamentationType.NeighborTone, typeof(PassingToneOrnamentationCleaner))]
    [TestCase(OrnamentationType.DelayedDoublePassingTone, OrnamentationType.NeighborTone, typeof(PassingToneOrnamentationCleaner))]
    [TestCase(OrnamentationType.RepeatedDottedEighthSixteenth, OrnamentationType.NeighborTone, typeof(PassingToneOrnamentationCleaner))]
