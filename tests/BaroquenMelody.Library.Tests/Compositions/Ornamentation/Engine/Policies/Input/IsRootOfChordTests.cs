...
[TestFixture]
internal sealed class IsRootOfChordTests
{
    private IsRootOfChord _isRootOfChord;
    ...
    public void SetUp()
    {
        ...
        _isRootOfChord = new IsRootOfChord(chordNumberIdentifier, compositionConfiguration);
    }
