...
internal sealed class DoubleTurnProcessorTests
{
    ...
    [Test]
    public void Process_applies_ascending_double_turn_as_expected()
    {
        // arrange
        ...
        noteToAssert.Ornamentations[3].Raw.Should().Be(Notes.E4);
        noteToAssert.Ornamentations[4].Raw.Should().Be(Notes.D4);
        noteToAssert.Ornamentations[5].Raw.Should().Be(Notes.E4);
        noteToAssert.Ornamentations[6].Raw.Should().Be(Notes.F4);
    ...
    [Test]
    public void Process_applies_descending_double_turn_as_expected()
    {
        // arrange
        var ornamentationItem = new OrnamentationItem(
            Instrument.One,
        ...
        noteToAssert.Ornamentations[3].Raw.Should().Be(Notes.A3);
        noteToAssert.Ornamentations[4].Raw.Should().Be(Notes.B3);
        noteToAssert.Ornamentations[5].Raw.Should().Be(Notes.A3);
        noteToAssert.Ornamentations[6].Raw.Should().Be(Notes.G3);
