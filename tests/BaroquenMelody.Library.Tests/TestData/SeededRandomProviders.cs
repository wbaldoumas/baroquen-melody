...
///     sequence, and it is kept apart from the shared stream so shuffling never shifts a later pass's draws.
/// </summary>
internal static class SeededRandomProviders
{
    ...
    public static SeededRandomProvider ForProcessorShuffle(int seed) => new(unchecked(seed ^ ProcessorShuffleSalt));
}
